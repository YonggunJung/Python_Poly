...
infile = open("class01_1.txt", "r", encoding='utf-8-sig')
infile2 = open("class01_1.txt", "r", encoding='utf-8-sig')
outfile = open("class01_1out", "w", encoding='utf-8-sig')
# print(len(infile.readlines()))
n = len(infile2.readlines())
infile2.close()
